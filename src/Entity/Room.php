...
class Room
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnvailablePeriod", mappedBy="room")
     */
    private $unvailablePeriods;
    ...
    public function __construct()
    {
        ...
        $this->unvailablePeriods = new ArrayCollection();
    }
    ...
    public function isOwner(Owner $ownertest) : bool 
    {
        return $this->owner == $ownertest;
    }
}
