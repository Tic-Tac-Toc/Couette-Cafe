 ...
 */
final class Version20191125102354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, owner_id INTEGER DEFAULT NULL, client_id INTEGER DEFAULT NULL)');
